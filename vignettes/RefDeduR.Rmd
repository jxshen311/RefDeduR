...
The transliteration process includes 2 parts: (1) transliterate greek letters to alphabets (e.g., β to beta, α to alpha) and (2) accented characters to ASCII characters (e.g., á to a, ä to a) using library "unidecode" in python.
